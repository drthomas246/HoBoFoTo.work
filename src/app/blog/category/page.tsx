  ...
  return (
    <div className="mx-auto my-5 max-w-4xl">
      ...
      <div className="container mt-5 flex h-96 items-center justify-center">
        <div className="overlay relative z-0 mx-auto my-0 max-h-full max-w-screen-md overflow-hidden p-12 text-center text-gray-100 before:absolute before:left-0 before:top-0 before:z-[-1] before:size-full before:blur-lg before:content-['']">
